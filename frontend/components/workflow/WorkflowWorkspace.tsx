...
export function WorkflowWorkspace({ jobId }: { jobId: string }) {
  ...
  return <div className="space-y-5">
    ...
    <div className="sticky top-3 z-20 rounded-xl border border-[var(--accent)]/50 bg-[var(--surface)]/95 backdrop-blur p-4 shadow-lg">
